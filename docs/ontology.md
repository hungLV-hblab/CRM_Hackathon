...
Người dùng: `Sales` (nhiều tài khoản, mỗi người **phụ trách** một số công ty qua `Company.owner_id`) và `Admin` (xem đo lường chất lượng, chỉnh tham số, tắt AI — và thấy được dữ liệu của mọi Sales).

**Phân quyền theo người phụ trách là thật, không phải mặc định của view** ([ADR-0046](decisions/0046-phan-quyen-theo-nguoi-phu-trach-toan-he-thong.md)): một Sales chỉ **đọc** và chỉ **ghi** được trong phạm vi công ty mình phụ trách; công ty chưa gán người phụ trách thì chỉ Admin thấy, và số bị loại phải được **đếm rồi nói ra** chứ không im lặng giấu (luật 4). Cổng phân quyền viết theo chiều *thu hẹp trừ khi là Admin*, và actor người không có vai trò thì bị từ chối. Luật này sống ở **tầng domain**, không có tầng CSDL đỡ lưng — khác với trần tự chủ của AI (mục 4), vốn được `GRANT` theo cột chặn thêm một lớp.
...
- ~~Chưa rõ Admin có được thao tác CRM không (Q-6) → chưa viết được ma trận quyền đầy đủ.~~ **Đã chốt 14/08:** vòng 1 Admin có quyền CRM y hệt Sales, chỉ khác màn quản trị → [ADR-0033](decisions/0033-vong-1-admin-co-quyen-crm-nhu-sales-ma-tran-quyen-chi-tiet-ngoai-pham-vi.md). **Cập nhật 15/08:** ADR-0033 tự nêu điều kiện xem lại là *"seed có từ hai người sở hữu trở lên"*; điều kiện đó xảy ra khi [ADR-0045](decisions/0045-dang-nhap-demo-tai-dung-luong-mat-khau-va-dashboard-scope-theo-vai.md) đổi seed thành nhiều Sales (nay là 5, nhập từ cột `sales_owner`). Nay đã có ma trận theo người phụ trách → [ADR-0046](decisions/0046-phan-quyen-theo-nguoi-phu-trach-toan-he-thong.md). Admin vẫn giữ quyền CRM đầy đủ; chỉ mệnh đề "chưa có ma trận theo người sở hữu" bị thay.
